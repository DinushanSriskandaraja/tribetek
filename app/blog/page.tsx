        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
          {posts.map((post) => (
            <Link
              key={post.slug}
              href={`/blog/${post.slug}`}
              className="group relative block bg-gradient-to-b from-[#12121234] to-[#0d0d0d34] border border-[#1e1e1e] rounded-3xl overflow-hidden hover:border-[#ED4716]/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(255,107,44,0.25)]">
